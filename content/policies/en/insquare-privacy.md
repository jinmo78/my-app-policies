...
- An account number used to tell users apart
...
Photos are saved again on upload. Hidden capture data such as location is not kept.
...
### (4) Advertising
- For free use, Google ads may appear. To show ads, an advertising identifier, network address, approximate device data, and ad taps or views may be processed. On iPhone, denying tracking still lets the app work; personalized ads may be limited.
...
| Role | Description |
|------|------|
| Sign-in | Google, Apple, Kakao |
| Accounts, posts, alerts | Cloud servers |
| Photo storage and delivery | Cloud storage |
| Ads | Google ads |
| Feedback and reports | Google Forms |
...
- The user’s posts, comments, and photos
...
Sign-in, cloud storage, ads, and alerts may be processed on servers outside Korea, only for the purposes above.

## 10. Security
Reasonable protection such as encrypted connections is used. Internet transmission and storage cannot be guaranteed completely secure.
